<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_XBSLOG_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4> <br>

    <p class="even">This module provides logging for XOOPS<br> <br>

        <br>

<{*        More Help information: <a href="<{$xoops_url}>/modules/<{$smarty.const._MI_XBSLOG_DIRNAME}>/admin/help.php" target="_blank"> XBS Docs</a>*}>
<{*        <br><br>*}>
    </p>

    <h4 class="odd"><span style="color: #FF0000; ">NEW: </span>CLASS &amp; FUNCTIONS API</h4><br>
    <p class="even">
        For <strong> Class and Function definitions </strong>  see: <a href="<{$xoops_url}>/modules/<{$smarty.const._MI_XBSLOG_DIRNAME}>/docu/index.html" TARGET="_blank">XBS Log Class Documentation </a>
        <br><br>
    </p>
    ...
    <p class="even">
        Tutorial has been started, but we might need your help! Please check out the status of the tutorial <a href="https://www.gitbook.com/book/xoops/xbslog-tutorial/" target="_blank">here </a>.
        <br><br>To contribute to this Tutorial, <a href="https://github.com/XoopsDocs/xbslog-tutorial/" target="_blank">please fork it on GitHub</a>.
    ...
    <p class="even">
        This module is Open Source and we would love your help in making it better! You can fork this module on <a href="https://github.com/XoopsModules25x/xbslog" target="_blank">GitHub</a><br><br>
