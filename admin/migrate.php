...
/** @var Xbslog\Common\Configurator $configurator */
$configurator = new Xbslog\Common\Configurator();

/** @var \XoopsModules\Xbslog\Common\Migrate $migrator */
$migrator = new \XoopsModules\Xbslog\Common\Migrate($configurator);
